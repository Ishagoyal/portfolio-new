...
const FashionPanel = ({ onWatchDemo }: { onWatchDemo: (opener: HTMLElement) => void }) => <section id="fashion-case-study" className="inline-case-study" aria-labelledby="fashion-case-heading">
  ...
  <div className="case-moments">
    <section className="case-moment"><p className="case-label">The constraint</p><h5>Recommendations must come from the user’s actual wardrobe.</h5><button type="button" className="watch-demo" onClick={(event) => onWatchDemo(event.currentTarget)}><Play size={14} fill="currentColor" /> Watch working demo</button></section>
...
const Portfolio = () => {
  ...
  return <div className={`site-shell${dark ? " dark" : ""}`}>
    ...
    <main>
      ...
      <section className="profile section-wrap"><SectionTitle number="01">Profile</SectionTitle><div className="profile-copy"><p><strong>I turn early user evidence into focused product decisions and testable prototypes.</strong></p></div></section>
